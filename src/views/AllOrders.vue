<template>
  <div class="p-4 md:p-8 space-y-6">
    ...
    <OrderFormModal v-model="isFormOpen" :order="editingOrder" :pending="store.isMutating" :attachment-status="activeAttachmentStatus" @submit="handleSubmit" @retry-attachment="retryAttachment" @download-attachment="downloadAttachment" @delete-attachment="deleteAttachment" />
