...
export class OrdersService {
  constructor(private repository: OrdersRepository, private attachmentCleanup?: { removeAllForOrder(orderId: string, userId: string): Promise<void> }) {}
  ...
  async delete(id: string, userId: string) {
    if (this.attachmentCleanup) await this.attachmentCleanup.removeAllForOrder(id, userId)
